  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <h1 className="font-display font-black text-3xl tracking-tight">Dietas</h1>
      </div>
      ...
      <div className="bg-surface border border-[rgba(255,255,255,0.08)] rounded-2xl overflow-hidden">
        <div className="px-5 py-4 border-b border-[rgba(255,255,255,0.08)]">
          <p className="text-xs font-display uppercase tracking-widest text-muted">
            Clientes activos ({clientes?.length ?? 0})
          </p>
        </div>
        {!clientes?.length ? (
          <div className="px-5 py-8 text-center text-muted text-sm">
            Sin clientes activos.{" "}
            <Link href="/admin/clientes/nuevo" className="text-accent hover:underline">Agrega uno</Link>
          </div>
        ) : (
